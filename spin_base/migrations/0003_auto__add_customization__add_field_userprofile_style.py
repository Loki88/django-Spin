...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'spin_base_customization', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('well_color', self.gf('django.db.models.fields.CharField')(max_length=6)),
            ('nav_color', self.gf('django.db.models.fields.CharField')(max_length=6)),
            ('background_color', self.gf('django.db.models.fields.CharField')(max_length=6)),
            ('background_image', self.gf('django.db.models.fields.FilePathField')(path='/home/loki/Scrivania/Tesi/Applicazione Tesi/spin/static/CUSTOMIZATION/', max_length=100)),
        ))
        db.send_create_signal('spin_base', ['Customization'])

        # Adding field 'UserProfile.style'
        db.add_column(u'spin_base_userprofile', 'style',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='style_users', null=True, to=orm['spin_base.Customization']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Customization'
        db.delete_table(u'spin_base_customization')

        # Deleting field 'UserProfile.style'
        db.delete_column(u'spin_base_userprofile', 'style_id')
    ...
    models = {
        ...
        'spin_base.customization': {
            ...
            'background_image': ('django.db.models.fields.FilePathField', [], {'path': "'/home/loki/Scrivania/Tesi/Applicazione Tesi/spin/static/CUSTOMIZATION/'", 'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nav_color': ('django.db.models.fields.CharField', [], {'max_length': '6'}),
