...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.activation'
        db.add_column(u'spin_base_userprofile', 'activation',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.activation'
        db.delete_column(u'spin_base_userprofile', 'activation')
