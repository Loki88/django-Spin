...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Customization.nav_color'
        db.delete_column(u'spin_base_customization', 'nav_color')

        # Adding field 'Customization.nav_inverse'
        db.add_column(u'spin_base_customization', 'nav_inverse',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'Customization.background_image'
        db.alter_column(u'spin_base_customization', 'background_image', self.gf('django.db.models.fields.FilePathField')(max_length=100, path='/home/loki/Scrivania/Tesi/Applicazione Tesi/spin/static/CUSTOMIZATION/', null=True))

    def backwards(self, orm):
        # Adding field 'Customization.nav_color'
        db.add_column(u'spin_base_customization', 'nav_color',
                      self.gf('django.db.models.fields.CharField')(default=True, max_length=6),
                      keep_default=False)

        # Deleting field 'Customization.nav_inverse'
        db.delete_column(u'spin_base_customization', 'nav_inverse')


        # Changing field 'Customization.background_image'
        db.alter_column(u'spin_base_customization', 'background_image', self.gf('django.db.models.fields.FilePathField')(default=True, path='/home/loki/Scrivania/Tesi/Applicazione Tesi/spin/static/CUSTOMIZATION/', max_length=100))
    ...
    models = {
        ...
        'spin_base.customization': {
            ...
            'background_color': ('django.db.models.fields.CharField', [], {'max_length': '6'}),
            'background_image': ('django.db.models.fields.FilePathField', [], {'max_length': '100', 'path': "'/home/loki/Scrivania/Tesi/Applicazione Tesi/spin/static/CUSTOMIZATION/'", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nav_inverse': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'well_color': ('django.db.models.fields.CharField', [], {'max_length': '6'})
        },
        'spin_base.multispin': {
