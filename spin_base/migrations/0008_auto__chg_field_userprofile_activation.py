...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.activation'
        db.alter_column(u'spin_base_userprofile', 'activation', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.activation'
        db.alter_column(u'spin_base_userprofile', 'activation', self.gf('django.db.models.fields.CharField')(default=None, max_length=200))
    ...
    models = {
        ...
        'spin_base.comment': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'comments'", 'to': "orm['spin_base.UserProfile']"}),
        ...
        'spin_base.userprofile': {
            ...
            'activation': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
