...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Customization.well_color'
        db.alter_column(u'spin_base_customization', 'well_color', self.gf('django.db.models.fields.CharField')(max_length=6, null=True))

        # Changing field 'Customization.background_color'
        db.alter_column(u'spin_base_customization', 'background_color', self.gf('django.db.models.fields.CharField')(max_length=6, null=True))

        # Changing field 'Customization.background_image'
        db.alter_column(u'spin_base_customization', 'background_image', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Customization.well_color'
        db.alter_column(u'spin_base_customization', 'well_color', self.gf('django.db.models.fields.CharField')(default=None, max_length=6))

        # Changing field 'Customization.background_color'
        db.alter_column(u'spin_base_customization', 'background_color', self.gf('django.db.models.fields.CharField')(default=None, max_length=6))

        # Changing field 'Customization.background_image'
        db.alter_column(u'spin_base_customization', 'background_image', self.gf('django.db.models.fields.FilePathField')(path='/home/loki/Scrivania/Tesi/Applicazione Tesi/spin/static/CUSTOMIZATION/', max_length=100, null=True))
